...
//This is same example as in keerti course and also implemented similarly as youtube example (Written here just for reference).
interface Observer {
...
public class SwiggyOrderStatusObserver{
