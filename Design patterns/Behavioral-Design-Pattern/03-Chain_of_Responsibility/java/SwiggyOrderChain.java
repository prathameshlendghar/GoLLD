...
class OrderValidationHandler extends OrderHandler {
    ...
    //Now this thing is just calling the parent parameterised contructor which will set the nextHandler state.
    //Now this nextHandler state is there in all subclass i.e inherited so setting it at one place will reflect in base class too.
